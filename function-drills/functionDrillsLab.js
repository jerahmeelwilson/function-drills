...
let faveColorFinder = function(color){
  ...
  } else if(color.toString().toLowercase() === "green"){
    return "so trendy";
  } else{
...
function buyFrog1(gold){
  const frogCost = 3;
  return Math.floor((gold/frogCost));
}

let totalFrogs1 = buyFrog1(4);
...
let arrayIsAscending1 = inOrder(sampleArray1);
